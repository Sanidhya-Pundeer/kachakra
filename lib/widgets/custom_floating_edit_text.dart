...
class CustomFloatingEditText extends StatelessWidget {
  ...
  _buildDecoration() {
    return InputDecoration(
      ...
      filled: _setFilled(),
      isDense: true,
      contentPadding: _setPadding(padding:FloatingEditTextPadding.PaddingT17L16),
    );
  }
    ...
    switch (variant) {
      case FloatingEditTextVariant.OutlineRed700:
        return OutlineInputBorder(
          borderRadius:_setOutlineBorderRadius(shape:FloatingEditTextShape.RoundedBorder8),
