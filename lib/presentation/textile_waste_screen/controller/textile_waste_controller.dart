...
import '../models/textile_waste_model.dart';

class TextileWasteController extends GetxController {
  ...
  Rx<TextileWasteModel> sendPackageModelObj = TextileWasteModel().obs;
