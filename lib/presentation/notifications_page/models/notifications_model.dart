...
class NotificationsModel {
  ...
  static List<NotificationsItemModel> notificationsItemList() {
    return [
      NotificationsItemModel("Collection Vehical - Delayed",
          "Due to heavy rainfall collection ride is delayed by an hour", "3 h ago"),
      NotificationsItemModel("Your request is generated",
          "Your Request has been placed successfully", "3 h ago"),
      NotificationsItemModel("Recycle waste offer",
          "shipment with discount package insurance rates", "5 h ago"),
      NotificationsItemModel("New Pick up Location",
          "Due to road blockage! New pickup location: Sodal Chowk", "8 h ago"),
