...
class RedeemStationsMapItemWidget extends StatelessWidget {
  RedeemStationsMapItemWidget(
  ...
  NearbyService courierItemModelObj;

  var controller = Get.find<RedeemStationsMapController>();
