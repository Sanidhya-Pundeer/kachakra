...
import 'package:courier_delivery/presentation/buy_stickers_screen/models/buy_stickers_model.dart';
...
class BuyStickersController extends GetxController {
  ...
  Rx<BuyStickersModel> sendPackageModelObj = BuyStickersModel().obs;
int packageQuentyty = 1;
  ...
  Future<void> generateRequest() async {
    ...
    String service_name = 'Buy QR Codes'; // Replace with your logic
    String replacement_part = ''; // Replace with your logic
    String type_of_waste = ''; // Replace with your logic
    String weight = ''; // Replace with your logic
    ...
    String transaction_number = '5974511111169'; // Replace with your logic
