...
import '../controller/home_container_controller_industry.dart';
...
class SlidermaskgroupItemWidget extends StatelessWidget {
  ...
  HomeSliderIndustry slidermaskgroupItemModelObj;

  var controller = Get.find<HomeContainerIndustryController>();
