...
import '../models/chemical_waste_model.dart';

class ChemicalWasteController extends GetxController {
  ...
  Rx<ChemicalWasteModel> sendPackageModelObj = ChemicalWasteModel().obs;
