                  ...
                  child: Column(
                    children: [
                      ...
                      if (selectedItem != null)
                        ScrapWasteIndustryEampleList(selectedItem: selectedItem!),
                    ],
                  ),
                ),
              ],
...
class ScrapWasteIndustryEampleList extends StatefulWidget {
  final String? selectedItem;

  ScrapWasteIndustryEampleList({required this.selectedItem});

  @override
  _CardItemListState createState() => _CardItemListState();
}

class _CardItemListState extends State<ScrapWasteIndustryEampleList> {
  int? selectedIndex;
