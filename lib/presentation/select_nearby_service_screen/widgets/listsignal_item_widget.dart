...
class ListsignalItemWidget extends StatelessWidget {
  ...
  NearbyService listsignalItemModelObj;
  int index;

  SelectNearbyServiceController selectCourierServiceController =
      Get.put(SelectNearbyServiceController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SelectNearbyServiceController>(
      init: SelectNearbyServiceController(),
