...
class SelectNearbyServiceScreen extends StatefulWidget {
  const SelectNearbyServiceScreen({Key? key}) : super(key: key);

  @override
  State<SelectNearbyServiceScreen> createState() =>
      _SelectCourierServiceScreenState();
}

class _SelectCourierServiceScreenState
    extends State<SelectNearbyServiceScreen> {
  SelectNearbyServiceController controller =
      Get.put(SelectNearbyServiceController());
        ...
        child: ColorfulSafeArea(
            ...
            child: Scaffold(
                ...
                appBar: CustomAppBar(
                    ...
                    centerTitle: true,
                    title: AppbarSubtitle1(text: "Nearby Services".tr),
