...
import 'package:courier_delivery/presentation/select_pickup_address_screen/models/select_pickup_address_model.dart';
...
class SelectPickupAddressController extends GetxController {
 List<ListeyeItemModel> pickuoAddressDAta = SelectPickupAddressModel.listeyeItemList();
