...
import 'package:courier_delivery/presentation/request_pe_bag_screen/models/request_pe_bag_model.dart';
...
class RequestPeBagController extends GetxController {
  ...
  Rx<RequestPeBagModel> sendPackageModelObj = RequestPeBagModel().obs;
int packageQuentyty = 1;
  ...
  Future<void> generateRequest() async {
    ...
    String service_name = 'Request PE Bag'; // Replace with your logic
    String replacement_part = ''; // Replace with your logic
    String type_of_waste = ''; // Replace with your logic
    String weight = '20 Kg'; // Replace with your logic
    ...
    String transaction_number = '78418483261485'; // Replace with your logic
