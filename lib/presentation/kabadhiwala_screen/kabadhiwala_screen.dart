...
import '../select_nearby_service_screen/widgets/listsignal_item_widget.dart';
import 'controller/kabadhiwala_controller.dart';

class KabadhiwalaScreen extends StatefulWidget {
  const KabadhiwalaScreen({Key? key}) : super(key: key);

  @override
  State<KabadhiwalaScreen> createState() =>
      _SelectCourierServiceScreenState();
}

class _SelectCourierServiceScreenState
    extends State<KabadhiwalaScreen> {
  KabadhiwalaController controller =
      Get.put(KabadhiwalaController());
        ...
        child: ColorfulSafeArea(
            ...
            child: Scaffold(
                ...
                appBar: CustomAppBar(
                    ...
                    centerTitle: true,
                    title: AppbarSubtitle1(text: "Kabadhiwala's Near you".tr),
