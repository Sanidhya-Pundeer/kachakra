...
class HomeData{
  static List<HomeSlider> getSliderData(){
    return [
      HomeSlider(ImageConstant.imgSliderChemical,"Schedule your Chemical Waste",AppRoutes.chemicalWasteScreen),
      HomeSlider(ImageConstant.imgSliderTextile,"Schedule \nTextile Waste",AppRoutes.textileWasteScreen),
      HomeSlider(ImageConstant.imgSlider2nd,"Broken Stuff? \nGet it Repaired!!",AppRoutes.nearbyServicesScreen),
      HomeSlider(ImageConstant.imgSlider3rd,"Donate/Trade your Books.",AppRoutes.bookTradeScreen),
    ];
  }
